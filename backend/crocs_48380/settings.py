"""
Django settings for crocs_48380 project.
...
WSGI_APPLICATION = 'crocs_48380.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "CROCS Support <support@crocs-48380.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "crocs_48380 API",
    "DESCRIPTION": "API documentation for crocs_48380 App",
    "VERSION": "v1",
}
